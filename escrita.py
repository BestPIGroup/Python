...
with open(arquivo_csv, mode="w",encoding="utf-8") as file:
    writer = csv.writer(file, delimiter=",")
    writer.writerow(["Nome", " Data", " CPU(%)", " Mémoria-total", " Mémoria-livre", " Mémoria-used", " Mémoria-free", " Mémoria(%)", " Disco-total", " Disco-used", " Disco-free"])
...
with open(arquivo_csv, mode="a",encoding="utf-8") as file:
    ...
    for i in range (1, 41):
        ...
        writer.writerow([nome, timestamp, cpu, round(memoria_total_gb, 2), round(memoria_available_gb, 2), round(memoria_used_gb, 2), round(memoria_free_gb, 2), round(disco_total_gb, 2), round(disco_used_gb, 2), round(disco_free_gb, 2)])
